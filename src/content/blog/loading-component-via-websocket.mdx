---
title: "Lazy Loading React Components via Websocket"
...
So, I've been tinkering with **Scratch GUI** lately, and holy moly – their bundle size is a whopping _30MB_ (15MB gzipped)! Like any sane developer, I thought, "Time for some lazy loading magic." But as I dug into React's `lazy` API, I realized there's more to it than meets the eye.
